...
# example: ./bin/build.sh ghcr.io/vindops/mariadb:11.8.3

# Check CVEs
./bin/cve.sh <YOUR_MARIADB_VERSION>
# example: ./bin/cve.sh ghcr.io/vindops/mariadb:11.8.3

# Flatten image
./bin/crane.sh <YOUR_MARIADB_VERSION>
# example: ./bin/crane.sh ghcr.io/vindops/mariadb:11.8.3
```
