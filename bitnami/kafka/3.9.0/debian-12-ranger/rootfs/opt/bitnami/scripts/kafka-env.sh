...
kafka_env_vars=(
  ...
  KAFKA_HEAP_OPTS
  JAVA_TOOL_OPTIONS
  KAFKA_RANGER_ENABLED
  KAFKA_RANGER_REPO_NAME
)
...
export KAFKA_RANGER_ENABLED="${KAFKA_RANGER_ENABLED:-true}"
export KAFKA_RANGER_REPO_NAME="${KAFKA_RANGER_REPO_NAME:-'kafka'}"
export KAFKA_RANGER_LOG_LEVEL="${KAFKA_RANGER_LOG_LEVEL:-'INFO'}"
